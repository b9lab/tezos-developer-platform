...
Then you see the class `FA2_core` which implements the FA2 strict standard. With some other classes, which implement usefull functions, it is inherited by the `FA2` class.
