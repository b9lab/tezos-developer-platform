...
There are other [useful options](https://tezostaquito.io/docs/wallet_api/#--tzip-10-wallet), like `eventHandlers` which should be utilised for better user experience in a real application. Anyway we will keep it simple and set only what must be set. 
