...
We will dive deeper into Tezos' consensus mechanism in the section _Main Ideas Behind the Tezos Protocol - Change and Evolution: Implementing change without hard forks_.
...
`youtube: https://youtu.be/ymK7Ss-HBPc`
