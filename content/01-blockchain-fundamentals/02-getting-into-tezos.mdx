...
slug: /blockchain-fundamentals/history
---
...
* the Tezos consensus mechanis, Liquid Proof-of-Stake, and
* smart contract development and deployment.

## Tackling the management problems of public chains

Blockchains can be categorised along two main deployment patterns: Public and private/managed blockchains. The deployment pattern has major implications on the fucntioning of a network.
...
### Managed blockchains: Bringing back access controll
...
### Public vs managed: Its all about suitability
...
Besides the **governance process** allowing for upgrades on-chain, the Tezos consensus mechanism assists in making the protocol more resilient against attack vectors and security risks other chains relying on PoW and PoS mechanisms are faced with. Among other, Tezos' consensus mechanis secures the network against malicious nodes.
...
<!-- Convert in expandable box at later point of time -->
...
* One of the design choices with Tezos is to allow for a language which makes the output easier to understand. Michelson does not present you with a long row of numbers, but instead offers expressions. A program written in Michelson consists of a series of instructions run in sequence.</li>
