---
title: A New Way of Distributed Networks
description: From the origins to Tezos as a P2P network
...
[Delphi](https://blog.nomadic-labs.com/delphi-official-release.html) tackled gas consumption, storage costs, and smart contracts to continue optimizing the network. [Edo](https://tezos.foundation/edo-proposal/) included, next to some bug fixes, improvements to performance and gas consumption to lower gas fees, as well as some changes to the upgrade process, and the introduction of [sapling](https://blog.nomadic-labs.com/sapling-integration-in-tezos-tech-preview.html) for shielded transactions and [tickets](https://medium.com/tqtezos/tickets-on-tezos-part-1-a7cad8cc71cd).


The three updates introduced in 2021 are envisioned to further improve the protocol for usage. [Florence](https://blog.nomadic-labs.com/florence-our-next-protocol-upgrade-proposal.html) brought with it further gas optimization, introduced a doubled maximum operation size, improved performance, two new normalization RPCs, a depth-first execution order for inter-contract calls, and a more reliable and streamlined amendment process by deactivating the testchain feature in the _Testing Period_. The Florence upgrade can be seen as a reaction to an increase in network activity observed after Delphi. This becomes clear when taking a closer look at the number of contract calls on Tezos: Until February 2021, the number of contract calls had been increasing but remained less than 100,000 calls per month. In March, the number had risen to ~ 360,000, and later in April 2021, the contract calls surpassed 1.3 million. The [Granada](http://doc.tzalpha.net/protocols/010_granada.html) upgrade not only included bug fixes and improvements such as further measures to reduce gas consumption, but also an upgrade of the consensus algorithm from Emmy+ to [Emmy<sub>\*</sub>](https://research-development.nomadic-labs.com/faster-finality-with-emmy.html) to achieve smaller block times and faster finality and liquidity backing. With liquidity backing, decentralized liquidity between tez and tzBTC is freed by minting tez every block and depositing it in a certified product marketing manager (CPMM) smart contract. Later, the [Hangzhou](http://doc.tzalpha.net/protocols/011_hangzhou.html) protocol upgrade is the 8th protocol upgrade for Tezos and was envisioned to prepare a consensus upgrade in 2022 to [Tenderbake](https://wiki.tezosagora.org/learn/futuredevelopments/fdconsensus). Hangzhou added a timelock to allow smart contracts including counter-measures against Block Producer Extractable Value. In addition, developers can register Michelson expressions as "constants" to reference them in contracts, and Michelson on-chain views are possible to provide smart contracts with a new mechanism for contract calls, so to say smart contracts can now read the storage of other contracts. The use of storage was further optimized with faster access to caching results, which also increases the throughput of the Tezos protocol. The upgrade also included context flattening to increase the processing of operations and blocks and some changes regarding liquidity baking.

<HighlightBox type="tip">

Want to take a closer look at past upgrades, the changes they brought, and even discover their related merge requests? Check out the [Tezos documentation](http://doc.tzalpha.net/protocols/naming.html).
...
![P2P network - A distributed architecture](images/P2PNetwork.png)
...
![Network types: Centralized, decentralized, distributed](images/PaulBaran.png)
...
- [Ethereum Whitepaper: A Next Generation Smart Contract & Decentralised Application Platform](https://ethereum.org/en/whitepaper/)
...
- [Guenzburger, Eli (2021): Tickets on Tezos](https://medium.com/tqtezos/tickets-on-tezos-part-1-a7cad8cc71cd)
...
- [Moskoy, Phillip (2018): What Is Bit Gold? The Brainchild of Blockchain Pioneer Nick Szabo](https://coincentral.com/what-is-bit-gold-the-brainchild-of-blockchain-pioneer-nick-szabo/)
- [Nomadic Labs (2019): Sapling integration in Tezos - Tech Preview](https://blog.nomadic-labs.com/sapling-integration-in-tezos-tech-preview.html)
- [Nomadic Labs (2020): Delphi: Official Rrelease](https://blog.nomadic-labs.com/delphi-official-release.html)
- [Nomadic Labs (2021): Florence: Our Next Protocol Upgrade Proposal](https://blog.nomadic-labs.com/florence-our-next-protocol-upgrade-proposal.html)
- [Nomadic Labs (2021): Announcing Tezos' 9th protocol upgrade proposal "Ithaca"](https://research-development.nomadic-labs.com/announcing-tezos-9th-protocol-upgrade-proposal-ithaca.html)
...
- [Tezos Agora Wiki](https://wiki.tezosagora.org/)
- [Tezos Developer Portal](https://developers.tezos.com/)
- [Tezos Documentation: Athens](http://doc.tzalpha.net/protocols/004_Pt24m4xi.html)
- [Tezos Documentation: Babylon](http://doc.tzalpha.net/protocols/005_babylon.html)
- [Tezos Documentation: Carthage](http://doc.tzalpha.net/protocols/006_carthage.html)
- [Tezos Documentation: Delphi](http://doc.tzalpha.net/protocols/007_delphi.html)
- [Tezos Documentation: Edo](http://doc.tzalpha.net/protocols/008_edo.html)
- [Tezos Documentation: Florence](http://doc.tzalpha.net/protocols/009_florence.html)
- [Tezos Documentation: Granada](http://doc.tzalpha.net/protocols/010_granada.html)
- [Tezos Documentation: Hangzhou](http://doc.tzalpha.net/protocols/011_hangzhou.html)
- [Tezos Documentation: Ithaca](http://doc.tzalpha.net/protocols/012_ithaca.html)
- [Tezos Foundation (2019): Update: Week of 21 Octoberr 2019](https://tezos.foundation/update-week-of-21-october-2019/)
- [Tezos Foundation (2020): Tezos Teams Propose Latest Protocol Upgrade, Edo](https://tezos.foundation/edo-proposal/)
- [Tezos Info (2021): Hangzhou — New Proposal for Tezos’ Eighth Protocol Upgrade](https://medium.com/@TezosInfo/hangzhou-new-proposal-for-tezos-eighth-protocol-upgrade-cd52c8e4ef3b)
- [Tezos Medium Publication](https://medium.com/tezos)
- [Tezos (2021): Florence, Tezos' Sixth Protocol Upgrade Goes Live, Bringing Further Gas Optimizations & More](https://medium.com/tqtezos/florence-tezos-sixth-protocol-upgrade-goes-live-bringing-further-gas-optimizations-more-557836cc63ba)
- [Wiser, Charlie (2019): Why Tezos is the Best Platform for Tokenized Assets](https://medium.com/tqtezos/why-tezos-is-the-best-platform-for-tokenized-assets-89a960cfa828)
