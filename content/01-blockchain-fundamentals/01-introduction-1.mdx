...
* **Gas optimization** to lower the cost of running complex smart contracts and increased performance for execution cycles of the Michelson interpreter through a change in the gas arithmetic;
...
* More intuitive smart contract development through a depth-first execution order for inter-contract calls (instead of a breadth-first execution order) by managing operations in a stack instead of a queue;
