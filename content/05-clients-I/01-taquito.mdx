...
`InMemorySigner` is a local signer implementation and is **NOT** meant to be used in production. For production, please have a look at the _[Beacon section](/ecosystem/beacon)_.
