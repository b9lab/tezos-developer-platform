...
and for the Florencenet, we can use:
...
Let's do something else not easy to do without the TzKT API and ask for the [number of smart contracts](https://api.tzkt.io/#operation/Accounts_GetCount) in Florencenet:
...
So the [current protocol](https://api.florencenet.tzkt.io/v1/protocols/current) is **PsFLorenaUUuikDWvMDr6fGBRG8kt3e3D3fHoXK1j1BFRxeSH4i**. 

<HighlightBox type="tip">

You can see supported Tezos protocols on [tzkt.io](https://tzkt.io/protocols) and check the details, e.g. for the [Florence protocol details](https://tzkt.io/PsFLorenaUUuikDWvMDr6fGBRG8kt3e3D3fHoXK1j1BFRxeSH4i/constants).
