...
description: Dive deeper into the language
slug: /smartpy/language
---

import HighlightBox from "../../src/components/HighlightBox"

Now, let's write a different smart contract, which sums all natural numbers from 0 to a given number: 
...
Take a look at this <a href="https://smartpy.io/dev/reference.html">SmartPy reference</a>. It contains a very useful overview.
