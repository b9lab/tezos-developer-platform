...
A TzKT indexer (tzkt-sync) is configured to extract data from the node in the sandbox. In addition, a TzKT API container exposes data to the platform.
