...
There is **no real investment or company** involved. All transactions are performed on the **Granada Testnet with testnet Tezos**. The tokens acquired cannot be traded on secondary markets and do not represent a real claim/value.
