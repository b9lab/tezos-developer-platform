...
Let's have a closer look at the system components to better understand how the web application runs and how the individual components relate to each other.
