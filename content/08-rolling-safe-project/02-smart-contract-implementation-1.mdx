...
B9lab's sample project is an implementation of a contnious programmable equity offering also known as a Rolling SAFE. For more details on this novel funding mechanism, take a look at the [introduction section](./what-is-a-cso).
