...
In case a liquidity event (like an acquisition) takes place before a priced equity round is done, the investors of a SAFE can either receive back their original investment amount, or convert their SAFE shares into common stock (based on the valuation cap set).
