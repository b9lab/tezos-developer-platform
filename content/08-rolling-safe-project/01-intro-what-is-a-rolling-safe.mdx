...
A simple agreement for future equity (SAFE) can be defined as *an agreement between a company, the issuer, and investors providing the investor rights for the company's future equity*.
