...
TzKT API is used to fetch information from the Tezos blockchain. You can find the methods the platform implements in the [chainWrapper](https://github.com/b9lab/tezos-cso-project) code.
