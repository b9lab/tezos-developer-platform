...
<OverviewBox title="Rolling SAFE Sample Application" linkHref="/rolling-safe-project" linkText="Rolling SAFE sample application" floating="true">
...
<ActionCardWrapper>
  ...
  <ActionCard href="/rolling-safe-system-architecture" text="System Architecture and Data Handling" desc="Dive deeper into planning with a closer look on B9lab's approach"></ActionCard>
  <ActionCard href="/rolling-safe-smart-contract-implementation-part-1" text="Smart Contract Implementation" desc="Want to take a look behind the curtains?"></ActionCard>
  <ActionCard href="/rolling-safe-platform-stack" text="Platform Stack" desc="Discover implementing interactions with the Tezos blockchain"></ActionCard>
  <ActionCard href="/rolling-safe-platform-tests" text="Testing, Testing, Testing" desc="Take a look at testing with the SmartPy IDE and unit testing for wrappers"></ActionCard>
  <ActionCard href="/rolling-safe-tezos-full-end-to-end-test" text="More Testing - A Full End-to-End Test Setup" desc="Create a test network, sandbox environment, and test the web application"></ActionCard>
</ActionCardWrapper>
