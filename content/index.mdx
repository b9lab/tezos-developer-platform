...
<OverviewBox title="All you need to develop with Tezos" imgSrc="/placeholder-image.png" floating="true">
...
Start with the Blockchain Fundamentals to understand the fundamentals of blockchain technology and how they translate into Tezos. As you work through the chapters, you will install everything you need to get started and dive deeper.
...
<OverviewBox title="Tezos Introduction:" linkHref="/blockchain-fundamentals/introduction-1" linkText="Tezos Introduction" imgSrc="/placeholder-image.png" floating="true">
...
<OverviewBox title="Getting to Know Tezos:" linkHref="/tezos-basics/architecture" linkText="Getting to Know Tezos" imgSrc="/placeholder-image.png" floating="true">
...
<OverviewBox title="Writing Smart Contracts:" linkHref="/smartpy/intro" linkText="Writing Smart Contracts" imgSrc="/placeholder-image.png" floating="true">
...
<OverviewBox title="More Smart Contract Development:" linkHref="/michelson" linkText="More Smart Contract Development" imgSrc="/placeholder-image.png" floating="true">
...
<OverviewBox title="Clients:" linkHref="/michelson" linkText="Clients" imgSrc="/placeholder-image.png" floating="true">
...
(TODO: To be added below)

<ActionCardWrapper title="Ecosystem">
  <ActionCard href="/quickstart/wallet" text="The FA2 interface" desc="Learn how to work with the FA2 interface for Tezos"></ActionCard>
  <ActionCard href="/quickstart/verification-with-cdd" text="Harbinger and Chainlink" desc="Learn how to use Harbinger and Chainlink with Tezos"></ActionCard>
  <ActionCard href="/quickstart/quickstart-polyx" showDevSign="true" text="Beacon" desc="Learn all about Beacon and how to work with the Beacon SDK"></ActionCard>
</ActionCardWrapper>
