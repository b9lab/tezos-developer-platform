---
title: Michelson - Smart Contract Language
...
Do you want to take a closer look at core data types and notations, check this out: [https://tezos.gitlab.io/master/whitedoc/michelson.html#core-data-types-and-notations](https://tezos.gitlab.io/master/whitedoc/michelson.html#core-data-types-and-notations).
...
[here](https://tezos.gitlab.io/master/whitedoc/michelson.html#domain-specific-data-types).
...
For a more detailed account on stack operations, we recommend: [https://tezos.gitlab.io/master/whitedoc/michelson.html#stack-operations](https://tezos.gitlab.io/master/whitedoc/michelson.html#stack-operations).
...
More on operations on strings? Check out: [https://tezos.gitlab.io/master/whitedoc/michelson.html#operations-on-strings](https://tezos.gitlab.io/master/whitedoc/michelson.html#generic-comparison).
...
For a closer look at the full grammar of Michelson, go [here](https://tezos.gitlab.io/master/whitedoc/michelson.html#full-grammar]).
...
* [An Introduction to Michelson: The Scripting Language of Tezos (Part 1)](https://betterprogramming.pub/introduction-to-michelson-the-language-of-tezos-part-1-374c03394cc3) by Calude Barde
...
* [An Introduction to Michelson: The Scripting Language of Tezos (Part 3)](https://medium.com/coinmonks/an-introduction-to-michelson-the-scripting-language-of-tezos-part-3-70bb294cd19e) by Calude Barde
