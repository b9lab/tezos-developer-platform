...
<td>Placeholter with value <code>Unit</code>
</td>
</tr>
<tr>
...
In addition, there are [syntatic sugars](https://tezos.gitlab.io/mainnet/whitedoc/michelson.html#compare) for `COMPARE`.
