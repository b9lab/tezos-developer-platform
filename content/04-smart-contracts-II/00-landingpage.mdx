...
* CameLIGO, our repeater contract, and how to handle storage,
...
Now, we will dive deeper into smart contract writing and deployment through taking a look at Michelson and LIGO. We will introduce the languages, its basics, and how they can be applied to previous smart contract examples.
</OverviewBox>
