...
<ActionCard href="/tezos-basics/testnet-1" text="Testnet - First Steps" desc="Let’s participate in a Tezos network! The first steps, first private key, and working with the testnet."></ActionCard>
