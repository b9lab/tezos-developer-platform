...
Now that we tackled our first steps and writing our first smart contract, why don't we turn to the JSON/RPC interface.
...
You can find the reference for the JSON/RPC interface at the [Tezos Developer Resources documentation](https://tezos.gitlab.io/api/rpc.html).
