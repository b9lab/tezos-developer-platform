...
Tezos itself is implemented in [OCaml](https://ocaml.org/). OCaml is a functional programming language used in mission-critical industries that require formal proofs of properties of programs. There also is [Michelson](https://tezos.gitlab.io/mainnet/whitedoc/michelson.html), a domain-specific language used to write smart contracts on Tezos. It is stack-based, strongly typed, and designed to facilitate formal verification so developers can more easily prove smart contract properties.
...
<ul>
	<li><a href="https://wiki.tezosagora.org/learn/smartcontracts">Smart Contracts on Tezos</a> in the Tezos Agora Wiki</li>
    <li><a href="https://betterprogramming.pub/introduction-to-michelson-the-language-of-tezos-part-1-374c03394cc3">An Introduction to Michelson: The Scripting Language of Tezos (Part 1)</a> by Calude Barde</li>
    <li><a href="https://betterprogramming.pub/an-introduction-to-michelson-the-scripting-language-of-tezos-part-2-4cc972c8237c">An Introduction to Michelson: The Scripting Language of Tezos (Part 2)</a> by Calude Barde</li>
    <li><a href="https://medium.com/coinmonks/an-introduction-to-michelson-the-scripting-language-of-tezos-part-3-70bb294cd19e">An Introduction to Michelson: The Scripting Language of Tezos (Part 3)</a> by Calude Barde</li>
    <li><a href="https://youtu.be/4oG4Ead74xA">Michelson presentation</a> by Benjamin Canou</li>
    <li><a href="https://tezos.com/assets/files/whitepaper-d0cd272790ed3ba5951b30d019db2013.pdf">Tezos White Paper</a></li>
  	<li><a href="https://tezos.com/assets/files/position-paper-00b110d6223dc6b84ac206e92171ed47.pdf">Tezos Position Paper</a></li>
    ...
    <li><a href="https://wiki.tezosagora.org/">TQ Tezos Wiki</a></li>
    <li><a href="https://medium.com/tezos">Tezos Medium Publications</a></li>
