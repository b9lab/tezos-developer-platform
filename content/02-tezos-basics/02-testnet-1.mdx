...
Let us get some **testnet** tez to work with! The easiest way to get some _testnet_ tez is through the [faucet](https://faucet.tzalpha.net/). It will not only give you free tez but also a brand new wallet (public-private key pair) on Hangzhounet, which you will have to copy into your node container.
