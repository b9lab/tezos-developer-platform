...
If you have difficulties to sync up, you can try to import a [snapshot](https://snapshots-tezos.giganode.io/).
...
will remove all blockchain data, so please if you made good progress with syncing up and you can estimate the time left, it will be better to wait. 
